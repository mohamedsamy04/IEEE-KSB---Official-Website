        ...
        <div className="max-w-[700px] mx-auto bg-white rounded-[30px] p-6 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-[#FAFAFA] p-5 rounded-[15px]">
                <RadioGroup onValueChange={(value) => setFormData({ ...formData, track: value })} className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem
                      value="technical"
                      id="track-technical"
                      className="w-[13px] h-[13px] border border-[#B9B9B9] before:w-[7px] before:h-[7px] before:bg-[#005682] focus:border-[#005682] focus:ring-[#005682]"
                    />
                    <Label htmlFor="track-technical" className="text-[#8B8B8B] text-[14px] font-poppins font-normal">
                      Technical Track
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem
                      value="non-technical"
                      id="track-non-technical"
                      className="w-[13px] h-[13px] border border-[#B9B9B9] before:w-[7px] before:h-[7px] before:bg-[#005682] focus:border-[#005682] focus:ring-[#005682]"
                    />
                    <Label
                      htmlFor="track-non-technical"
                      className="text-[#8B8B8B] text-[14px] font-poppins font-normal"
                    >
                      Non-Technical Track
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem
                      ...
                      className="w-[13px] h-[13px] border border-[#B9B9B9] before:w-[7px] before:h-[7px] before:bg-[#005682] focus:border-[#005682] focus:ring-[#005682]"
                    />
                    <Label htmlFor="track-programming" className="text-[#8B8B8B] text-[14px] font-poppins font-normal">
                      Programming Track
                    </Label>
                  </div>
                </RadioGroup>
